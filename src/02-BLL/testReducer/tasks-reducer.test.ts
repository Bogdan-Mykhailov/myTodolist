...
test('correct task should be added to correct array', () => {
  ...
  const endState = tasksReducer(startState, addTaskAC({id: '5', title: 'Redux 🎮', status: TaskStatuses.Completed, description: '', priority: TaskPriorities.Low, startDate: '', deadline: '',  todoListId: 'todoListId2', order: 0, addedDate: ''}))
...
test('new array should be added when new todolist is added', () => {
  ...
  const endState = tasksReducer(startState, addTodolistAC(newTodolistTitle, 'newTodolistId'))
